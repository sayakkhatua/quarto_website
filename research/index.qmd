...
<summary>Abstract</summary>
The intricate relationship between the dynamics of property prices and private
credit has long been a focal point for economists and policymakers, particularly
in light of its pivotal role in financial crises and economic instability. Despite its
significance, the nuances of this relationship across different levels of economic
development remain underexplored. In this paper, using quarterly data from 27
countries over the period 1982-2021, we employ a robust empirical strategy that
addresses potential endogeneity concerns through instrumental variables. Our
findings reveal a significant positive relationship between property price growth
and private credit expansion, with the effect being stronger in developed countries.
A one percentage point increase in property prices is associated with a 0.25 to
0.36 percentage point increase in private credit growth in developed economies,
while the effect is smaller but still positive in developing countries. We also find
that macroeconomic factors such as GDP growth, inflation, and interest rates play
important moderating roles in this relationship. Additionally, our results suggest
that the property price-credit nexus has evolved over time, with notable shifts
occurring around major economic events. Our findings not only advance our
understanding of a critical economic relationship but also provide a foundation for
more effective policy responses to property market dynamics and credit growth.
</details>
...
**Research Transparency and Reproducibility at the  International Initiative for Impact Evaluation** *(Journal of Development Effectiveness)* </br> with Sean Grant

<a href="https://doi.org/10.1080/19439342.2024.2388102"> Open Access </a>
...
<a href="https://doi.org/10.1002/cl2.1149"> Open Access </a>
...
**Short-Term Versus Long-Term Effects of Forced Displacement** (in Land Acquisition in Asia) </br>
...
**How Many Replicators Does It Take to Achieve Reliability? Investigating Researcher Variability in a Crowdsourced Replication** </br>
